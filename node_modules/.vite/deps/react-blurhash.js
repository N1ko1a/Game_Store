...
var g = (e, s) => {
  ...
  if (e != null && m)
    for (var r of m(e))
      s.indexOf(r) < 0 && x.call(e, r) && (t[r] = e[r]);
  return t;
};
var o = class extends f.PureComponent {
  constructor() {
    ...
    this.draw = () => {
      ...
      if (this.canvas) {
        let i = j(t, a, r, n), c = this.canvas.getContext("2d"), d = c.createImageData(a, r);
  ...
  render() {
    ...
    return f.createElement("canvas", p(h({}, a), { height: r, width: n, ref: this.handleRef }));
  }
};
...
var u = class extends l.PureComponent {
  ...
  render() {
    let w = this.props, { hash: s, height: t, width: r, punch: n, resolutionX: a, resolutionY: i, style: c } = w, d = g(w, ["hash", "height", "width", "punch", "resolutionX", "resolutionY", "style"]);
    return l.createElement("div", p(h({}, d), { style: p(h({ display: "inline-block", height: t, width: r }, c), { position: "relative" }) }), l.createElement(o, { hash: s, height: i, width: a, punch: n, style: D }));
  }
};
